        ...
        return args -> {
            ...
            for (int i = 0; i < 5; i++) {
                Objet objet = new Objet(
                        utilisateurService.obtenirUtilisateurParId(1L), "aaaa", "aaaaaa",
            ...
            Objet objet = new Objet(
                    utilisateurService.obtenirUtilisateurParId(5L), "aaaa", "aaaaaa",
                    CategorieObjet.LITTERATURE, LocalDateTime.now());
            objetRepository.save(objet);
            Objet objet2 = new Objet(
                    utilisateurService.obtenirUtilisateurParId(4L), "aaaa", "aaaaaa",
                    CategorieObjet.GAMING, LocalDateTime.now());
